...
export const experience = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Built a backend proxy for live demos and mentored three junior developers on test-driven development, improving quality on core flows."
    ]
  },
  {
  ...
  },
  {
    ...
    where: "Tel-Aviv, Israel",
    bullets: [
      "Delivered seven high-traffic PHP/Node.js projects serving millions monthly.",
      "Built a cross-browser extension framework to speed delivery across major browsers.",
      "Created headless-browser QA automation to reduce regressions and shorten test cycles."
    ]
  },
  {
    ...
    where: "Tel-Aviv, Israel",
    bullets: [
      "Expanded extension support to Thunderbird, Safari, IE, Chrome, and mobile; improved update turnaround through a practical UI-loading workaround."
    ]
  }
];
...
export const projects = [
  {
    ...
    demo: "https://supportdesk-app-demo.up.railway.app",
    desc: "Flagship SupportDesk: roles (admin/agent/user), tickets, comments, audit log, search/filters, tests, Docker + CI.",
  ...
  },
  {
    ...
    demo: "https://supportdesk-admin-ui-demo.up.railway.app",
    desc: "Thin demo admin UI for the adjacent SupportDesk API service: list/detail/status update, strong loading/error states, CI.",
